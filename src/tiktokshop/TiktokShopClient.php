...
class TiktokShopClient
{
    ...
    protected $sdkVersion = "tiktokshop-sdk-php-20220701";
    ...
    protected function generateSign($apiName, $params): string
    {
        ...
        // dd($apiName, $params, $stringToBeSigned);
    ...
    /**
     * 发送请求
     * @param TiktokShopRequest $request
     * @param $accessToken
     * @return bool|string
     * @throws Exception
     */
    public function execute(TiktokShopRequest $request, $accessToken = null)
    {
